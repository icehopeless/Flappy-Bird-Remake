...
class FlappyBird{
    ...
    shared_ptr<sf::Sprite> bird, pipetop, pipeback, background, credito, restart, quit, insta,git; // ponteiros inteligentes para fazerem alocações dinâmicas em  Sprites
    sf::Texture bird_Texture[3], pipe,bg, credito_texture, restart_texture,quit_texture, insta_texture, git_texture;  
